...
const WC_CRITERIA = [
  ...
  "The beneficiary can self-propel in a standard wheelchair in the home; and the beneficiary can and does self-propel in a lightweight wheelchair.",
...
const WC_CODES = {
  standard: [
    ...
    {code:"E2611", desc:"POSITIONING WHEELCHAIR BACK CUSHION, WIDTH LESS THAN 22 INCHES, ANY DEPTH"},
    {code:"", desc:""},
  ],
  lightweight: [
  ...
  bariatric: [
    ...
    {code:"E2612", desc:"POSITIONING WHEELCHAIR BACK CUSHION, BARIATRIC, WIDTH 22 INCHES OR GREATER"},
    {code:"", desc:""},
  ]
};
